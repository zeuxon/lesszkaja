...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Nov 06. 10:42
...
ALTER TABLE `raktar_alaposszetevok`
  ADD KEY `alaposszetevok_nev` (`alaposszetevok_nev`,`raktar_raktarid`),
...
ALTER TABLE `raktar_osszetevok`
  ADD PRIMARY KEY (`raktar_raktarid`,`osszetevok_nev`),
...
--
-- Megkötések a táblához `alaposszetevok`
--
ALTER TABLE `alaposszetevok`
  ADD CONSTRAINT `alaposszetevok_ibfk_1` FOREIGN KEY (`nev`) REFERENCES `raktar_alaposszetevok` (`alaposszetevok_nev`) ON DELETE CASCADE ON UPDATE CASCADE;

...
--
-- Host: localhost:3306
-- Generation Time: Dec 04, 2024 at 08:35 AM
...
CREATE TABLE `alaposszetevoje` (
  ...
  `alaposszetevok_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
...
CREATE TABLE `etterem` (
  `id` int(11) NOT NULL,
  `nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `emailcim` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
...
(28, 'asd', 'asd@asd.com', '$2a$10$rittr4AmB9pDfnQC.8nsvuFRrqpEPNrTJ/M8U.CNj.DZIUxQOcfhC', '12345678965', 'asd', 0, 0);
...
CREATE TABLE `kosar` (
  ...
  `felhasznalo_felhasznalonev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `etterem_cim` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `osszetevoje` (
  `osszetevok_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `termek_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `raktar` (
  `id` int(11) NOT NULL,
  `osszetevo` varchar(255) COLLATE utf8_hungarian_ci DEFAULT NULL,
...
CREATE TABLE `tartalmaz` (
  ...
  `allergenek_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
